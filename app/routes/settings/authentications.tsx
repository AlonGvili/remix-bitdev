      ...
      <div className="flex flex-col space-y-2 mt-8">
        ...
        <div className="border rounded-md p-8 flex flex-col justify-center items-center py-24 space-y-4">
          ...
          <button className="text-violet-400 hover:text-violet-600 font-semibold ">
            Authenticate a device to this account.
          </button>
        </div>
        ...
        <div className="border rounded-md p-8 flex flex-col justify-center items-center py-24 space-y-4">
          ...
          <button className="text-violet-400 hover:text-violet-600 font-semibold ">
            Configure an SSH key pair to this account.
          </button>
        </div>
      </div>
      <button className="bg-violet-500 hover:bg-violet-600 font-semibold text-white py-2 px-6 mt-6 rounded-md max-w-max">
        New
      </button>
    </div>
  );
