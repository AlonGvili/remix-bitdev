  ...
  return (
    <div className="flex flex-col space-y-8 pl-16 w-full">
      ...
      <div className="max-w-2xl border border-gray-300 p-2 rounded-md flex items-center justify-between">
        <h1 className="text-base pl-4 font-bold text-gray-600">
          Go Pro to collaborate on private code
        </h1>
        <Link to="/upgrade">
          <button className="py-2 px-6 max-w-max w-full bg-violet-500 hover:bg-violet-600 text-white font-bold rounded-md">
            Upgrade
          </button>
        </Link>
      </div>
              ...
              <>
                <Disclosure.Button className="py-2 font-semibold text-sm max-w-2xl w-full flex items-center justify-between">
                  ...
                  {!open ? (
                    ...
                    <RiArrowDownSFill className="rotate-180" />
                  )}
                </Disclosure.Button>
                <Disclosure.Panel className="text-gray-500 max-w-max">
                  For personal hobby and open source
                </Disclosure.Panel>
              </>
            )}
          </Disclosure>
          ...
          <Disclosure>
            {({ open }) => (
              <>
                ...
                <Disclosure.Panel className="text-gray-500 max-w-max">
                  Currently the system does not enforce a limit on monthly CI
                  minutes.
                </Disclosure.Panel>
              </>
            )}
