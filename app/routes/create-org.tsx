	...
	return (
		<div className="w-screen h-screen z-50 absolute overflow-x-hidden inset-0 bg-white">
			...
			<div className="flex flex-col max-w-2xl py-24 space-y-4 mx-auto my-auto justify-items-center h-full">
				...
				<Form method="post" className="space-y-6 max-w-2xl pb-12 flex flex-col justify-between">
					...
					<h1 className="font-bold text-2xl text-gray-600">Choose your plan and start 30 days free</h1>
					<RadioGroup value={plan} onChange={setPlan} className="grid grid-cols-2 gap-6">
						<RadioGroup.Option value="community">
							{({ checked }) => (
								<div
									className={`flex flex-col justify-center items-center p-6 space-y-4 cursor-pointer ${
										checked ? "border-2 border-violet-600 rounded-lg" : "border-2 border-gray-200 rounded-lg"
									}`}
								>
									...
									<h1 className="font-semibold text-gray-700 text-sm">For open-source communities</h1>
									<ul role="list" className="marker:text-violet-500 marker:text-lg list-disc pl-5 space-y-2 text-slate-400">
										...
										<li className="font-semibold text-sm">Unlimited public scopes</li>
										<li className="font-semibold text-sm">Team management</li>
										<li className="font-semibold text-sm">120 CI minutes</li>
										<li className="font-semibold text-sm">Integrations (GitHub, Slack, WebHooks)</li>
						...
						<RadioGroup.Option value="business">
							{({ checked }) => (
								...
								>
									...
									<ul role="list" className="marker:text-violet-500 marker:text-lg list-disc pl-5 space-y-2 text-slate-400">
										<li className="font-semibold text-sm">Unlimited private scopes</li>
										<li className="font-semibold text-sm">5 members included *</li>
										<li className="font-semibold text-sm">Team management</li>
										<li className="font-semibold text-sm">Autoscaling CI with 3000 minutes</li>
										<li className="font-semibold text-sm">Integrations (GitHub, Slack, WebHooks)</li>
										<li className="font-semibold text-sm">Private component registry</li>
										<li className="font-semibold text-sm">Advanced invoice settings</li>
					...
					<button type="submit" className="bg-violet-500 hover:bg-violet-600 text-white font-bold py-3 px-6 rounded-md max-w-max">
						Create organization
					</button>
				</Form>
			</div>
