  ...
  return (
    <div className="w-screen h-screen z-50 absolute overflow-x-hidden inset-0 bg-white">
      ...
      <div className="flex flex-col max-w-2xl py-24 space-y-4 mx-auto my-auto justify-items-center h-full">
        <Form
          method="post"
          className="space-y-4 max-w-2xl pb-12 flex flex-col justify-between"
        >
          ...
          <ul role="list" className="space-y-4 text-slate-400">
            <li className=" text-base font-semibold text-gray-800">
              {loaderData?.profile?.displayName} will be the name of the
              organization.
            </li>
            <li className=" text-base font-semibold text-gray-800">
              You will not be able to sign-in to{" "}
              {loaderData?.profile?.displayName}
            </li>
            <li className=" text-base font-semibold text-gray-800">
              The total amount of collaborators across scope will be the members
              for the organization.
            </li>
            <li className=" text-base font-semibold text-gray-800">
              The transform process requires you to select a username for a new
              personal account.
            </li>
            <li className=" text-base font-semibold text-gray-800">
              All administrative privileges will be bestowed the new personal
              account.
            </li>
            <li className=" text-base font-semibold text-gray-800">
              Any user specific information (emails, tokens, passwords, etc)
              will move to a new account-name.
            </li>
          </ul>
        </Form>
        <div className="flex justify-between items-center">
          ...
          <Link to={`/${loaderData?.profile?.displayName}/migration`}>
            <button
              type="button"
              className="bg-violet-500 hover:bg-violet-600 text-white font-bold py-2 px-6 rounded-md max-w-max"
            >
